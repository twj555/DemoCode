...
{
   public class HuaBanCaiji
    {

       private int groupId = 0;
       private string savePath = string.Empty;
       public HuaBanCaiji(int groupId,string savePath)
       {
        ...
        private void DownloadImgs()
        {
            ...
            foreach (var item in imgList)
            {
                ...
                i += 1;
                var imgpaths = item.Split('/');
                string filepath = savePath + "\\" + GroupTitle + "\\" + imgpaths[imgpaths.Length-1] + ".jpg";
